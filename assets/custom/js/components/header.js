                ...
                <div class="">
                    <a class="dropdown-item">
                        <div class="">
                            ...
                            <div class="media">
                                <div class="user-img">
                                    <img class="usr-img rounded-circle" src="assets/img/profile-11.jpeg"
                                        alt="profile">
                                </div>
                    ...
                    <a class="dropdown-item">
                        <div class="">
                            ...
                            <div class="media">
                                <div class="user-img">
                                    <img class="usr-img rounded-circle" src="assets/img/profile-16.jpeg"
                                        alt="profile">
                                </div>
                                <div class="media-body">
                                    <div class="">
                    ...
                    <a class="dropdown-item">
                        <div class="">
                            ...
                            <div class="media">
                                <div class="user-img">
                                    <img class="usr-img rounded-circle" src="assets/img/profile-34.jpeg"
                                        alt="profile">
                                </div>
                                <div class="media-body">
                                    <div class="">
        ...
        <li class="nav-item dropdown user-profile-dropdown">
            ...
            <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                <div class="">
                    ...
                    <div class="dropdown-item">
                        <a href="auth_login.html"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
